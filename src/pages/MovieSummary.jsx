...
console.log('====================================');
  ...
  return (
        ...
        <div className='h-5/6 w-8/12 bg-slate-500 flex justify-center items-center  rounded-2xl         cursor-pointer sm:p-3 sm:hover:shadow-slate-400 sm:shadow-md sm:border sm:border-slate-400 sm:m-2 transition-shadow duration-200 group'>
